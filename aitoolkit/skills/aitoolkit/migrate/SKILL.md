---
name: migrate
description: Orchestrator pipeline migration của AIToolKit (10 bước discovery→mapping→tech-design→code-migration→review→test→gerrit→CCC→release→KB). Gọi step-skill tuần tự, dừng ở human gate. Kiểu Superpowers — không engine lưu trữ.
---
...
- Bước lấy input bước trước từ đường dẫn bạn truyền vào — KHÔNG lưu trữ trạng thái, KHÔNG hardcode tên file workflow khác.
