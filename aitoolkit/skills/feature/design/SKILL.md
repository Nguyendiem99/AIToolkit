...
Orchestrator gọi skill này, truyền: `run_dir` + đường dẫn `<run_dir>/01-requirements.md`. Chạy inline — orchestrator dừng ở gate Tech Lead.
...
4. Ghi `<run_dir>/02-design.md`, `status: draft`.
