...
Conductor gọi với `step_id`, `run_id`, `run_dir`. Bước nặng → subagent. OPTIONAL (tắt được qua --disable).
...
5. Ghi `<run_dir>/ccc-package.md`, `step_id` conductor truyền, `status: draft`. Trả về đường dẫn.
