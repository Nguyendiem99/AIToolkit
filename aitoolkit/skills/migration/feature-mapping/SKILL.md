...
## Việc cần làm
1. Đọc `aitoolkit-schemas`, template `aitoolkit/templates/mapping.md`, và `<run_dir>/01-discovery.md` (artifact bước trước = đường dẫn orchestrator truyền vào; bắt buộc phải có — thiếu thì báo lỗi).
...
5. Ghi `<run_dir>/02-mapping.md`, `status: draft`.
