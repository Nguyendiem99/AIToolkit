...
# Foundation Migration Plan Fixture
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | UNIT-001 | required | pending-bootstrap | pending-step09-approval | none | Foundation structure ready for bootstrap | greenfield/design-new | TR-REQ-001, TR-RENDER-001 | one-unit-one-change | docs/aitoolkit/fixture-artifacts/08-foundation-migration-plan.md#UNIT-001 | approved |
...
|---|---|---|
| Approved foundation-unit plan | docs/aitoolkit/fixture-artifacts/08-foundation-migration-plan.md#UNIT-001 | Fixture demonstrates the pre-bootstrap lifecycle. |
